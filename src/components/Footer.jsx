...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>, href: "https://github.com/VARUN-BIT9090u8/IPL-AUCTION-LANDING", label: "GitHub" },
    { icon: <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>, href: "", label: "Portfolio" },
    { icon: <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>, href: "", label: "LinkedIn" }
  ];
  ...
  return (
    <footer className="mt-32 w-full max-w-6xl mx-auto px-6 border-t border-white/5 pt-16 pb-12 z-10 relative">
      ...
      <div className="absolute top-0 left-1/4 -translate-y-1/2 w-72 h-72 bg-yellow-600/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-10 md:gap-8 pb-12">
        ...
        <div className="col-span-1 sm:col-span-6 md:col-span-3 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="pt-1">
              <a
                href="mailto:varunbandi31@gmail.com"
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          <ShieldCheck size={12} className="text-yellow-500/70" />
